                        ...
                        <div className="row">
                            ...
                            <div className="col-xl-3 col-md-6">
                                <div className="project-item">
                                    ...
                                    <div className="project-content">
                                        <div className="left-side-content">
                                            <h4 className="title"><Link href="/project-details">Inventory Management</Link></h4>
                            ...
                            <div className="col-xl-3 col-md-6">
                                <div className="project-item">
                                    ...
                                    <div className="project-content">
                                        <div className="left-side-content">
                                            <h4 className="title"><Link href="/project-details">Business Accounting</Link></h4>
                        ...
                        <div className="row justify-content-center">
                            <div className="col-12">
                                <div className="project-content-bottom">
                                    ...
                                    <Link href="/project-details" className="btn">See All Projects</Link>
                                </div>
                            </div>
                        </div>
                    </div>
