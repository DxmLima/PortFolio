                    ...
                    <div className="row gutter-24">
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="project__item-two">
                                ...
                                <div className="project__content-two">
                                    <h2 className="title"><Link href="/project-details">Digital Agency</Link></h2>
                        ...
                        <div className="col-lg-4 col-md-6">
                            <div className="project__item-two">
                                ...
                                <div className="project__content-two">
                                    <h2 className="title"><Link href="/project-details">Business Accounting</Link></h2>
                        ...
                        <div className="col-lg-8">
                            <div className="project__item-two">
                                ...
                                <div className="project__content-two">
                                    <h2 className="title"><Link href="/project-details">Business Consulting</Link></h2>
